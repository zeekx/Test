...
#import "CTPGNonRectangleView.h"

@implementation CTPGNonRectangleView
                                 ...
                                 const CGAffineTransform *m, CGRect rect)
{
    ...
    CGPathAddRoundedRect(path,
                         m,
                         CGRectMake(rect.origin.x + width * .618*.05, rect.origin.y + height * .618*.05,
                                    width *.0382, height * .0382),
                         0, 0);
    
    CGPathAddRoundedRect(path,
                         m,
                         CGRectMake(rect.origin.x * width * .1, rect.origin.y + height * .618*.5,
